...
export function DetailItemsTable({
  ...
  return (
    <>
      {/* Desktop View (Table) */}
      {noCard ? (
        <div className="hidden md:block">{desktopTableContent}</div>
      ) : (
        <Card className="p-4 hidden md:block">{desktopTableContent}</Card>
      )}
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <span className="ml-2 font-medium">{ukuranLabel || "-"}</span>
                </div>
                <div>
